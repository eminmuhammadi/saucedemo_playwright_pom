...
$ pytest tests/. -v --tags JIRA-0001 --browser=chromium --slowmo 500 --headed --html=report.html
...
$ PWDEBUG=1 pytest tests/. -v --tags JIRA-0001 --browser=chromium --slowmo 500 --headed --html=report.html