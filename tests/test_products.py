...
@pytest.mark.tags("JIRA-0001", "ui", "products")
...
@pytest.mark.tags("JIRA-0002", "ui", "products")
...
@pytest.mark.tags("JIRA-0003", "ui", "products")
...
@pytest.mark.tags("JIRA-0004", "ui", "products")
...
@pytest.mark.tags("JIRA-0005", "ui", "products")
...
@pytest.mark.tags("JIRA-0006", "ui", "products")
